! function(t) {
    ...
    window.common = {}, common.select = e(7).default, common.datePicker = e(2).default, common.dropifyInput = e(3).default, common.textEditor = e(8).default, common.fileInput = e(4).default, common.investModal = e(5).default, common.rejectedModal = e(6).default, common.authModal = e(1).default
}, function(t, n, e) {
    "use strict";
                        ...
                        methods: {
                            read: function(t) {
                                ...
                                if (e.length) {
                                    ...
                                    r.onload = function(t) {
                                        e[0] && (n.file.fileData = t.target.result, n.file.fileName = e[0].name, n.$emit("input", n.file))
                                    }, r.readAsDataURL(e[0])
                                }
                            }
                        }
                        ...
                        methods: {
                            read: function(t) {
                                ...
                                if (e.length) {
                                    var r = new FileReader;
                                    r.onload = function(t) {
                                        if (e[0].size / 1024e3 > n.size) return void n.$emit("error", e[0].size);
                                        n.file.fileData = t.target.result, n.file.fileName = e[0].name, n.$emit("input", n.file)
                                    }, r.readAsDataURL(e[0])
                                }
                            }
                        }
                    ...
                    return {
                        ...
                        mounted: function() {
                            ...
                            tinymce.init({
                                ...
                                media_alt_source: !1,
                                media_filter_html: !1,
                                paste_preprocess: function(t, n) {
                                    var e = n.content,
                                        r = $(document.createElement("div"));
                                    r.html(e), r.find("*").removeAttr("style"), r.find("img").each(function() {
                                ...
                                file_picker_callback: function(n, e, r) {
                                    var i = document.createElement("input");
                                    i.setAttribute("type", "file"), i.setAttribute("accept", "image/*"), document.body.appendChild(i), i.onchange = function(e) {
                                        ...
                                        if (r.length) {
                                            ...
                                            i.onload = function(e) {
                                                if (r[0]) {
                                                    var i = {};
                                                    i.fileData = e.target.result, i.fileName = r[0].name, t.imageSave(n, i)
                                                }
                                            }, i.readAsDataURL(r[0])
                                        }
                                    }, i.click()
                                    ...
                                    t.addButton("backgroundcolor", {
                                        ...
                                        onPostRender: function() {
                                            ...
                                            t.on("NodeChange", function(e) {
                                                var r = jQuery(t.selection.getNode()).hasClass("bg_color");
                                                n.active(r)
                                            })
                                        }
                                        ...
                                        onPostRender: function() {
                                            var n = this;
                                            t.on("NodeChange", function(e) {
                                                var r = jQuery(t.selection.getNode()).hasClass("txt_color");
                                                n.active(r)
                                            })
                                        }
                                        ...
                                        onPostRender: function() {
                                            var n = this;
                                            t.on("NodeChange", function(e) {
                                                var r = jQuery(t.selection.getNode()).hasClass("custom_underline");
                                                n.active(r)
                                            })
                                        }
                                        ...
                                        menu: [{
                                            ...
                                            tooltip: "인용구1",
                                            onclick: function() {
                                                var n = jQuery(t.selection.getNode()),
                                                    e = n.hasClass("blockquote_center"),
                                                    r = n.text();
                                                "" != r && " " != r || (r = "내용을 입력해주세요."), t.selection.getNode().parentNode.removeChild(t.selection.getNode()), e ? t.insertContent("<p> " + r + "</p>") : t.insertContent('<blockquote class="blockquote_center"> ' + r + " </blockquote>")
                                            },
                                            onPostRender: function() {
                                                var n = this;
                                                t.on("NodeChange", function(e) {
                                                    var r = jQuery(t.selection.getNode()).hasClass("blockquote_center");
                                                    n.active(r)
                                                })
                                            }
                                        }, {
                                            ...
                                            onclick: function() {
                                                var n = jQuery(t.selection.getNode()),
                                                    e = n.hasClass("blockquote_left"),
                                                    r = n.text();
                                                "" != r && " " != r || (r = "내용을 입력해주세요."), t.selection.getNode().parentNode.removeChild(t.selection.getNode()), e ? t.insertContent("<p> " + r + "</p>") : t.insertContent('<blockquote class="blockquote_left"> ' + r + " </blockquote>")
                                            },
                                            onPostRender: function() {
                                                var n = this;
                                                t.on("NodeChange", function(e) {
                                                    var r = jQuery(t.selection.getNode()).hasClass("blockquote_left");
                                                    n.active(r)
                                                })
                                            }
                                        }]
                                ...
                                init_instance_callback: function(n) {
                                    n.on("KeyUp", function(e) {
                                        t.$emit("input", n.getContent())
                                    }), n.on("Change", function(e) {
                                        t.$emit("input", n.getContent())
                                    }), n.setContent(t.removeStyleAttr(t.value))
                                }
                            })
                        },
                        destroyed: function() {
                        ...
                        methods: {
                            imageSave: function(t, n) {
                                $(".page-loader-more").fadeIn(""), axios.post("/file/upload", {
                                    fileType: "aws",
                                    file: n
                                }).then(function(e) {
                                    $(".page-loader-more").fadeOut(""), t("//" + e.data, {
                                        title: n.fileName
                                    })
                                })
                            },

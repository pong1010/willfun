...
<link rel="stylesheet" type="text/css" id="u0"
	href="https://www.ycrowdy.com/resources/js/tinymce/skins/white/skin.min.css">
</head>
...
<div id="user">
			<div>
				...
				<div class="container">
					<div class="navbar-header">
						...
						<ul class="nav navbar-nav">
							<li><a href="/reward/list" class="dropdown-toggle">리워드</a></li> <li><a
								href="/invest/list" class="dropdown-toggle">투자</a></li> <li><a
								href="/preopen/list" class="dropdown-toggle">사전공개</a></li> <li
								class="dropdown"><a href="javascript:void(0);"
								data-toggle="dropdown" role="button" aria-haspopup="true"
								aria-expanded="false" class="dropdown-toggle">
											더보기 <span class="caret"></span>
							</a> <div role="menu" class="dropdown-menu">
									<ul>
										<li><a href="/community/main">커뮤니티 파트너</a></li> <li><a
											href="/simulation/main">모의펀딩</a></li> <li><a
											href="/crowdy/about">리워드/투자란?</a></li> <li><a
											href="/crowdy/help" target="_blank">도움말</a></li>
									</ul>
								</div></li> <li><a href="/make/start"
							...
							<li class="nav-search-form"><form
								...
								</form></li> <li><div class="gnb_card_background"></div> <a href="#"
								class="dropdown-toggle open_my_card">
											마이페이지
										</a></li> <li><a href="/crowdy/help" target="_blank"
								class="dropdown-toggle">
											도움말
										</a></li>
						</ul>
					</div> <!---->
				</div></nav> <nav class="mobile-header-wrap">
				<div class="mobile-header">
					...
					</div> <a href="/" class="mobile-brand">CROWDY</a> <div
						class="gnb_card_background"></div> <a href="#"
						class="open_my_card mobile-icon-login"><span>마이페이지</span></a>
				</div> <!----> <div class="mobile-navbar">
					<ul class="mobile-nav">
						<li><a href="/reward/list" class="mobile-anav">리워드</a></li> <li><a
							href="/invest/list" class="mobile-anav">투자</a></li> <li><a
							href="/preopen/list" class="mobile-anav">사전공개</a></li> <li
							class="dropdown"><a href="javascript:void(0);"
							data-toggle="dropdown" role="button" aria-haspopup="true"
							aria-expanded="false" class="mobile-anav">
									더보기 <span class="caret"></span>
						</a> <div role="menu" class="dropdown-menu">
								<ul>
									<li><a href="/community/main">커뮤니티 파트너</a></li> <li><a
										href="/simulation/main">모의펀딩</a></li> <li><a
										href="/crowdy/about">리워드/투자란</a></li> <li><a
										href="/crowdy/help" target="_blank">도움말</a></li> <li><a
										href="/make/start">프로젝트 만들기</a></li>
								</ul>
							</div></li>
					</ul>
				</div></nav> <div class="gnb_card">
					<div class="gnb_card_frame">
						<div class="gnb_card_header">
							<div class="gnb_card_header_table">
								<div class="gnb_card_header_table_cell">
									<a href="javascript:void(0)" class="gnb_card_close">창닫기</a> <div
										class="user_photo">
										<!---->
									</div> <div class="user_name">천홍철</div> <div class="user_email">cjsghdcjf@nate.com</div>
								</div>
							</div>
						</div> <div class="gnb_card_body">
							<ul>
								<li><a href="#">펀딩한 프로젝트</a></li> <li><a
									href="/mypage/main?menu=2">제작한 프로젝트</a></li> <li><a
									href="/mypage/main?menu=3">관심 프로젝트</a></li> <li><a
									href="/mypage/main?menu=5">설정</a></li> <li><a
									href="javascript:void(0);">로그아웃</a></li>
							</ul>
						</div>
					</div>
				</div>
...
/*]]>*/
	...
	<div class="row">
		...
		<div class="col-sm-6 col-md-4">
			...
			<div class="enot_text">
				앗! 죄송해요..
				<p>모바일은 지원하지 않습니다. ㅠ_ㅠ <br> PC로 이용해주세요</p>
			</div>
			<div class="btn_wrap">
		...
		<div id="reward-make">
			<div id="list_wrap"
				...
				<div class="common_sub_vi bg_gray">
					<div class="container">
						<div class="row not-space">
							...
							</div> <div class="col-md-4 text-right"></div> <div class="col-md-5">
								<div class="row">
									<div class="col-md-6">
				...
				</div> <div class="common_sub_layout">
					<div class="container">
						<div class="row not-space">
							<div class="col-md-2">
								<div class="col-line-lm">
									<div class="st-navi-device-wrap">
										<span>프로젝트 미리보기</span> <div class="st-navi-device">
											<a>모바일</a> <a>태블릿</a> <a>PC</a>
										</div>
									</div> <ul class="st-navi st-navi-p">
										<li class="active"><a href="javascript:void(0)">프로젝트 만들기</a> <div
												class="list_link_tab">
												<ul>
													<li class=""><a href="javascript:void(0)">1. 기본정보</a></li> <li
														class="active"><a href="javascript:void(0)">2. 스토리</a></li> <li
														class=""><a href="javascript:void(0)">3. 리워드</a></li> <li
														class=""><a href="javascript:void(0)">4. 제작자/부가 정보</a></li>
												</ul>
											</div></li>
									</ul> <div style="cursor: pointer;">
										<img
											src="https://image-se.ycrowdy.com/crowdyCss/img/mypage_banner.png"
											style="width: 180px; padding-right: 10px;">
									</div>
								</div>
							</div> <!----> <div class="col-md-10 col-line">
								<div class="row not-space">
										...
										<div class="md-ml30">
											<form id="combinationForm" method="get" action="#"
												...
												<div class="form-group row-mobile-n">
													<label for="project_vod"
														class="col-xs-12 control-label control-label-big"><div
															class="text-left mb10">프로젝트 소개 영상과 이미지를 등록해주세요</div> <p
															class="form-control-static mb10 mt0">영상과 이미지를 함께 등록할 경우, 영상이 먼저 보여집니다.</p></label> <div
														class="col-xs-12">
														<div class="row row-mobile-n">
															<label for="vod_gallery" class="col-xs-12 control-label"><div
																	class="text-left">동영상 주소를 적어주세요</div></label> <div
																class="vod-holder input-append">
																<div class="row row-mobile-n">
																	<div class="col-xs-10 col-sm-7">
																		<input type="text"
																			placeholder="YouTube, Vimeo  URL을 입력해주세요"
																			class="form-control">
																	</div> <div class="col-xs-2 col-sm-1"
													...
													</div> <div class="col-xs-12 mt25">
														<label for="eligible[]" class="control-label"><div
																class="text-left">이미지를 등록해주세요</div></label> <div class="row">
															<div
																...
																<div class="dropify-wrapper touch-fallback">
																	<div class="dropify-message">
																		<span class="file-icon"></span> <p>최적 사이즈 740×417px</p>
															...
															</div> <div class="col-xs-6 col-sm-3 dropify-wrapper-197 mt10">
																<div class="dropify-wrapper dropify-wrapper-plus">+</div>
															</div>
														</div>
													</div>
												</div> <div class="form-group row-mobile-n">
													<label for="project_story"
														class="col-xs-12 control-label control-label-big"><div
															class="text-left mb10">프로젝트 스토리를 적어주세요</div> <p
															class="form-control-static mb10 mt0">
															<a class="red-800">프로젝트를 시작하기 위해 필요한 내용이 없다면 승인이 되지 않습니다. 프로젝트 가이드북</a>을 읽어보시고 매력적인 스토리를 적어주세요.</p></label> <div
														class="col-xs-12">
														<div>
												...
												이미지와 영상은 꼭 버튼을 이용하여 첨부해주세요.
																							...
																							<div id="mceu_6"
																								...
																								<button id="mceu_6-open" role="presentation"
																									...
																									<i class="mce-ico mce-i-none"
																										style="background-image: url('/resources/css/img/btn_icon_hr1.png')"></i> <i
																										class="mce-caret"></i>
																								</button>
																							</div>
																							<div id="mceu_7"
																								...
																								<button id="mceu_7-open" role="presentation"
																									type="button" tabindex="-1">
																									<i class="mce-ico mce-i-none"
																										style="background-image: url('/resources/css/img/btn_icon_bq1.png')"></i> <i
																										class="mce-caret"></i>
																								</button>
																							</div>
																						</div>
													...
													<label for="project_story"
														class="col-xs-12 control-label control-label-big"><div
															class="text-left mb10">환불 및 교환 정책을 적어주세요</div> <p
															class="form-control-static mb10 mt0">스토리 맨 아래에 노출됩니다.</p></label> <div
														class="col-xs-12">
														<div class="ps-wrap">
															<div class="row row-mobile-n mb15">
																<label for="project_policy"
																	class="col-xs-12 control-label"><div
																		class="text-left mb10">진행자의 환불 및 교환 정책<span
																			class="red-800">(필수사항)</span>
																	</div></label> <div class="col-xs-12">
																	<textarea rows="5" id="project_policy" title=""
																		placeholder="크라우디 환불 및 교환 정책 외에 추가사항이 있으시면 적어주세요."
																		class="form-control"></textarea>
																</div>
															</div> <div class="row row-mobile-n mb35">
																<label for="project_mobile1"
																	class="col-xs-12 control-label"><div
																		class="text-left mb10">문의 가능한 번호</div> <p
																		class="form-control-static mb10 mt0">번호 공개 여부를 선택해주세요.</p></label> <div
																	class="col-sm-6">
																...
																<label for="project_email"
																	class="col-xs-12 control-label"><div
																		class="text-left mb10">문의 이메일</div> <p
																		class="form-control-static mb10 mt0">반드시 적어주세요.</p></label> <div
																	class="col-sm-6">
																	<input type="text" id="project_email" maxlength="200"
																		title="" placeholder="info@ycrowdy.com"
																		class="form-control">
																</div>
															</div> <div class="textarea-style">
																<strong>크라우디의 환불 및 교환정책 기본사항</strong> <ul>
																	<li>1. 프로젝트 기간 중에는 자유롭게 <a
																		href="/mypage/main?menu=1&amp;sub-menu=1"
																		target="_blank">마이 페이지</a>에서 펀딩 취소가 가능합니다.</li> <li>2. 펀딩을 받아야만 생산을 시작할 수 있는 크라우드 펀딩 특성상, 프로젝트 종료 이후에는 단순 변심으로 인한 교환이나 환불이 불가하니 이점 양해 부탁드립니다.</li> <li>3. 리워드 배송일이 예상보다 지연되는 경우, 새소식과 후원자 분들의 이메일을 통해 안내해드리겠습니다.<br>이에 관한 문의는 이메일 "<a
																		href="mailto:cjsghdcjf@nate.com" target="_blank"
																		class="project_email red-800">cjsghdcjf@nate.com</a>"  , 연락처 "<a
																		href="tel:" class="red-800"></a>" 로 연락바랍니다.  <!----></li>
																</ul>
															</div> <ul class="con-icon blue-800 mb25">
																<li>프로젝트 종료일 이후에 리워드와 관련된 환불 및 교환은 프로젝트 제작자가 약속하는 것에 따르며 크라우디는 이에 책임지지 않습니다.</li>
															</ul>
														</div>
													</div>
												</div> <div class="form-group row-mobile-n mt90">
													<div class="col-sm-11">
														<div class="form-group row-mobile-n">
				...
				</div> <div id="confirmMd" tabindex="-1" role="dialog"
					data-backdrop="static" data-keyboard="false"
					class="modal fade deliveryModal">
					<div role="document" class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<div class="headerTitle" style="width: 70px;">승인 요청</div> <button
									type="button" aria-label="Close" class="xButton"
									data-dismiss="modal"></button>
							</div> <div class="modal-body">
								<div class="crowdy-confirm-title">확인해주세요!</div> <div
									class="mt20">
									<div class="row">
										<div class="ml10 mr10">
											<div class="crowdy-confirm-checkbox">
												<label class="crowdy-check-container03">
													크라우드펀딩 진행자가 사실과 다른 내용을 표시한 경우에는 형법상 사기에 해당할 수 있고, 표시광고법 위반에도 해당해 징역이나 벌금의 형벌에 처해지거나, 민사상 손해배상책임까지 지게 될 수 있습니다.
													<input type="checkbox" name="confirmCheck"> <span></span>
												</label>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="ml10 mr10">
											<div class="crowdy-confirm-checkbox">
												<label class="crowdy-check-container03">
													진행자가 제품에 대해 사실과 다르게 표시·광고하거나, 사실을 은폐하거나 축소하는 등의 방법으로 표시·광고한 경우에는 표시광고법위반에 해당해 형벌을 받게 될 수 있습니다.
													<input type="checkbox" name="confirmCheck"> <span></span>
												</label>
											</div>
										</div>
									...
									<div class="row">
										<div class="ml10 mr10">
											<div class="crowdy-confirm-checkbox">
												<label class="crowdy-check-container03">
													또한 이로 인해 피해를 입은 참여자들에게 손해배상을 해야할 수도 있음을 확인했습니다.
													<input type="checkbox" name="confirmCheck"> <span></span>
												</label>
											</div>
										</div>
									...
									<button id="confirmBtn" type="button"
										class="btn btn-block btn-primary btn-disabled-gray">승인 요청</button>
								</div>
							</div>
						</div>
					</div>
            	...
            	<div class="crowdy-footer-dangerTitle xs-mt20">투자위험고지</div>
      			<div class="mt5 crowdy-footer-dangerDesc">
        			스타트업 투자는 원금 손실과 유동성 및 현금성에 대한 투자위험을 가지고 있습니다. <br
							...
							class="hidden-lg ">
        			<a class="crowdy-color-blue" data-target="#irnModal"
							data-toggle="modal" href="#">투자위험고지 바로가기 <i
							aria-hidden="true" class="fa fa-angle-right ml5"></i></a>
    			</div>
    			<div class="mt20 xs-mt10 crowdy-footer-dangerDesc">
    				㈜크라우디는 중개업(온라인소액투자중개 및 통신판매중개)을 영위하는 플랫폼 제공자로 자금을 모집하는<br
							class="hidden-xs hidden-md "> 당사자가 아닙니다. 따라서 투자손실의 위험을 보전하거나 리워드 제공을 보장해 드리지 않으며 이에 대한 법적인 <br
							class="hidden-xs hidden-md ">책임을 지지 않습니다.
        			<br><br>
			        <div class="hidden-xs hidden-sm">
			         	<a href="https://goo.gl/maps/WhfViBP2f6WVWMLA7"
								style="font-size: 12px" target="_blank">경기도 성남시 수정구 대왕판교로 815 기업지원허브 814호</a> |  리워드 031-8039-5569  |  투자 070-8633-3183, 031-8039-5568 
			        </div>
    			</div>
	    	</div>
	    </div>
		...
		<div class="container">
			<div class="row row-mobile-n">
				<div class="col-md-5 col-xs-12 crowdy-footer-linkBox">
					<div class="col-sm-6 col-xs-12 md-pl0">
	                    ...
	                    <a class="nth-child3"
								...
								class="ml5" src="/resources/img/Sns_fb_icon.png"></a>
	                    <a class="nth-child8"
								href="http://pf.kakao.com/_tYuWu" target="_blank"><img
								src="/resources/img/Sns_kt_icon.png"></a>
	                    <a class="nth-child9"
								href="https://www.youtube.com/channel/UC4S5gcgft2CC2epZlkxww1Q"
								target="_blank"><img class="ml5"
								src="/resources/img/Sns_yt_icon.png"></a>
	                    <a class="nth-child9"
								href="http://blog.naver.com/crowdy0903" target="_blank"><img
								class="ml5" src="/resources/img/Sns_nv_icon.png"></a>
                    </div>       
                    <div class="col-sm-6 col-xs-12 xs-mt10 xs-pl13">                      
	                    ...
	                    <a class="nth-child3"
								...
								class="ml5" src="/resources/img/Sns_fb_icon.png"></a>
	                    <a class="nth-child8"
								href="https://pf.kakao.com/_MxhTVd" target="_blank"><img
								src="/resources/img/Sns_kt_icon.png"></a>
	                    <a class="nth-child9"
								href="https://www.youtube.com/channel/UC4S5gcgft2CC2epZlkxww1Q"
								target="_blank"><img class="ml5"
								src="/resources/img/Sns_yt_icon.png"></a>
	                    <a class="nth-child9"
								href="http://naver.me/GmoP5Mby" target="_blank"><img
								class="ml5" src="/resources/img/Sns_nv_icon.png"></a>
                    </div>  
				</div>
				<div class="col-md-7 col-xs-12 crowdy-footer-comInfo">
					<hr class="hidden-lg hidden-md"
							style="margin-left:-18px; margin-right:-18px;">
					통신판매업신고 : 2020-서울서초-0232 |&nbsp; 사업자등록번호 : 841 - 86 - 00201 |&nbsp; 대표자 : 김기석, 김주원 <span
							class="hidden-lg hidden-md" style="display: inline-block;">|</span>
	...
	<div id="ui-datepicker-div"
		...
		<div
			...
			<a class="ui-datepicker-prev ui-corner-all ui-state-disabled"
				title="이전 달"><span class="ui-icon ui-icon-circle-triangle-w">이전 달</span></a><a

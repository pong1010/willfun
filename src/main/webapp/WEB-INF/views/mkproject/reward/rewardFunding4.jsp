...
<body>
	...
	<script
		src="/resources/willfun/js/customer.script.min.js"></script>
	<script
			...
			<div id="list_wrap"
				...
				<div class="common_sub_vi bg_gray">
					<div class="container">
						<div class="row not-space">
							<div class="col-md-3">
								<div class="common_vi_title webfont2">제작자/부가 정보</div>
							</div>
										...
										<li class="active"><a href="javascript:void(0)">프로젝트
											...
											<div class="list_link_tab">
												<ul>
													...
													<li class="active"><a href="javascript:void(0)">4.
															제작자/부가 정보</a></li>
												</ul>
											</div></li>
									</ul>
											...
											<form class="form-horizontal">
												<div class="form-group row-mobile-n">
													<label for="project_vod"
														class="col-xs-12 control-label control-label-big"><div
															class="text-left mb10">계좌 정보를 입력해주세요</div>
														<p class="form-control-static mb10 mt0">프로젝트 종료 후
															입금받으실 계좌를 입력해주세요.</p></label>
													<div class="col-xs-12">
														<div class="row row-mobile-n mb20">
															...
															<div class="col-sm-3">
																<select tabindex="-1" class="select2-hidden-accessible"
																	aria-hidden="true"><option value="02">산업은행</option>
																	...
																	<option value="90">카카오뱅크</option></select><span
																	class="select2 select2-container select2-container--default"
																	dir="ltr" style="width: 102px;"><span
																	class="selection"><span
																		class="select2-selection select2-selection--single"
																		role="combobox" aria-haspopup="true"
																		aria-expanded="false" tabindex="0"
																		aria-labelledby="select2-m7kj-container"><span
																			class="select2-selection__rendered"
																			id="select2-m7kj-container" title="산업은행"></span><span
														...
														<div class="row row-mobile-n mb20">
															...
															<div class="col-sm-6">
																<div
																	class="input-group input-group-file dropify-wrapper-340">
												...
												<div class="form-group row-mobile-n">
													<label for="project_vod"
														...
														<p class="form-control-static mb10 mt0">크라우디 수수료에 한해서만
															세금계산서를 발급해 드립니다. 이 단계에서 사업자등록증을 올리지 않으시면 세금계산서를 발급받으실 수
															없습니다.</p></label>
													<div class="col-xs-12">
														<div role="tabpanel" id="tex_tab1" class="tab-pane active">
															<div class="row row-mobile-n mb20">
																<label for="tex1_company_email"
												...
												<div class="form-group row-mobile-n">
													<label for="partner_facebook"
														...
														<p class="form-control-static mb10 mt0">현재 운영 중인 곳의
															주소를 적어주세요. 진행자 정보에 노출됩니다.</p></label>
													<div class="col-xs-7 sns-group">
														<dl>
															<dt>
																<label for="partner_website"
																	class="icon_sns icon_website pointer"></label>
															</dt>
															<dd>
														...
														<dl>
															<dt>
																<label for="partner_blog"
																	class="icon_sns icon_blog pointer"></label>
															</dt>
															<dd>
																<input type="text" id="partner_blog"
																	placeholder="블로그 URL을 입력해주세요." class="form-control">
															</dd>
														</dl>
														<dl>
															<dt>
																<label for="partner_twitter"
																	class="icon_sns icon_twitter pointer"></label>
															</dt>
															<dd>
												...
												<div class="form-group row-mobile-n" style="display: none;">
													<label for="mc_partner"
														class="col-xs-12 control-label control-label-big"><div
															class="text-left mb10">
															커뮤니티 파트너를 선택해주세요 <span class="red-800">(선택사항)
																프로젝트가 시작해야 선택할 수 있습니다. </span>
														</div>
														<p class="form-control-static mb10 mt0">파트너와 협업을 원하는
															경우 선택해주세요. 신청은 프로젝트가 시작된 후에 가능합니다.</p></label>
													<div class="col-xs-7">
														<div class="row row-mobile-n">
															<div class="col-xs-7">
																<select tabindex="-1" class="select2-hidden-accessible"
																	...
																	class="selection"><span
																		...
																		role="combobox" aria-haspopup="true"
																		aria-expanded="false" tabindex="0"
																		aria-labelledby="select2-fljp-container"><span
																			class="select2-selection__rendered"
																			id="select2-fljp-container"></span><span
																			class="select2-selection__arrow" role="presentation"><b
																				role="presentation"></b></span></span></span><span
																	class="dropdown-wrapper" aria-hidden="true"></span></span>
															</div>
															<div class="col-xs-5">
																...
																<!---->
																<button type="button"
																	class="btn btn-block btn-primary-outline">파트너
																	승인 요청</button>
															</div>
														</div>
													</div>
...
g(c);c.getInstance=function(a){a=(a&&0!==a.length?a:"$default_instance").toLowerCase();c._iq.hasOwnProperty(a)||(c._iq[a]={_q:[]},g(c._iq[a]));return c._iq[a]};e.amplitude=c})(window,document);amplitude.getInstance().init("88ee3f94796e2cd53036c329ca2a87ec",null,{includeGclid:!0,includeUtm:!0,includeReferrer:!0});</script>
	<div id="ui-datepicker-div"
		...
		style="position: absolute; top: 741px; left: 510.172px; z-index: 1; display: none;">
		<div
